...
This is extended through the generic type `FatObj`. Refer to the API documentation of [`FatObj`](https://docs.rs/ribir_core/0.3.0-beta.2/ribir_core/builtin_widgets/struct.FatObj.html) to see all the extended capabilities it provides.
